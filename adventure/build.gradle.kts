...
base.archivesName = "SRB-Adventure"

repositories {
    mavenCentral()
}

val adventure = project.properties["adventure"]
dependencies {
...
tasks.withType<ProcessResources> {
    inputs.property("adventure_version", adventure)
...
tasks.withType<Jar> {
    manifest {
        attributes(
                ...
                "Implementation-Title" to "SRB-Adventure",
